...
function Calendar(p_item, p_WinCal, p_month, p_year, p_format) {
	...
	this.gBGColor = "black";/* цвет внешней рамки*/
	this.gFGColor = "black";
...
/*	this.wwriteA("<FONT FACE='" + fontface + "' SIZE=2><B>");
	...
	this.wwrite("<TABLE style='width: 100%; border: 0px;' CELLSPACING='0' CELLPADDING='0'><TR><TD>");/*Таблица навигации*/
	...
	this.wwrite("<A  class='redbold' HREF=\"" +
		...
		");" +
		"\"><b> < </b></TD><TD><b>");
/*	this.wwrite("<A HREF=\"javascript:window.print();\">Печать</A></TD><TD>");*/
	this.wwriteA(this.gMonthName + " " + this.gYear);
	this.wwrite("</b></TD><TD>");
	this.wwrite("<A  class='redbold' HREF=\"" +
		"javascript:window.opener.Build(" + 
